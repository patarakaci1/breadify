  ...
  return (
    <div className="about-wrapper">
      <div className="about-container container">
        <div>
          <p className="about-breadify">about breadify</p>
        ...
        <div>
          <p>
            Breadify was founded in 2024 to end the era of soggy,
            plastic-wrapped lunch sandwiches. What started as a late-night
            sourdough experiment quickly turned into a dedicated artisanal
            sandwich kitchen.
          </p>
          <p>
          ...
          <p>
            ...
            means crafting every sandwich with the quality, respect, and warmth
            a neighbor deserves.
          </p>
